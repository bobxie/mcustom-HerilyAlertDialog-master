package com.herily.dialog.activity;
...
public class MainActivity extends Activity {
	...
	public AlertDialog createProgressDialog() {
		...
		switch (rg.getCheckedRadioButtonId()) {
			...
			case R.id.radio2:
				return new HerilyProgressDialog(this);
			default:
				return null;
		}
	}
		...
		public void onClick(View v) {
			...
			switch (v.getId()) {
				case R.id.button11:
					...
					// }
					// });
					// pd.setProgressStyle(HerilyProgressDialog.STYLE_HORIZONTAL);
					// pd.setProgressStyle(HerilyProgressDialog.STYLE_SPINNER);
					...
					// HerilyProgressDialog.show(context, null, "正在-请稍等...",
					// false, true);
					break;
				case R.id.button10:
					View customFrame = LayoutInflater.from(context).inflate(R.layout.herily_alertex_dialog_custom_frame_layout, null);
...
//					handler.obtainMessage(1001, ad).sendToTarget();
				...
				case R.id.button1:
					...
					bd.setIcon(R.drawable.herily_alertex_dlg_title_icon_def);
